<template>
  <div>
    ...
    <v-dialog v-model="showDescriptionPokemon" width="700">
      <v-card v-if="selectPokemon" shaped>
        ...
        <v-container>
          <v-row>
            <v-col cols="4">
              <v-card justify="center" :img="backgroundPoke">
                <v-row justify="center">
                  <img
            ...
            <v-col cols="8">
              ...
              <v-chip
                v-for="(typePoke, i) in selectPokemon.types"
                :key="i"
                label
                class="mr-2"
              ...
              <v-divider class="my-4"></v-divider>
              <div v-for="(stats, i) in selectPokemon.stats" :key="i">
                <p class="mt-2 mb-0">{{ getName(stats.stat) }}</p>
                <v-progress-linear
                  v-model="stats.base_stat"
                  height="15"
                  :color="getColorType(selectPokemon.types[0].type.name)"
                >
                  <strong> {{ stats.base_stat }}/99 </strong>
                </v-progress-linear>
              </div>
            </v-col>
